...
desc 'Generate documentation for the localization_clap extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'LocalizationClapExtension'
...
desc 'Test the localization_clap extension.'
...
namespace :test do
  desc 'Functional test the localization_clap extension.'
  ...
  desc 'Unit test the localization_clap extension.'
